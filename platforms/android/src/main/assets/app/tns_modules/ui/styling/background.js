...
(function (ad) {
    ...
    function onBackgroundOrBorderPropertyChanged(v) {
        ...
        var leftPadding = v.style.paddingLeft ? v.style.paddingLeft : nativeView.getPaddingLeft() / density;
        var topPadding = v.style.paddingTop ? v.style.paddingTop : nativeView.getPaddingTop() / density;
        var rightPadding = v.style.paddingRight ? v.style.paddingRight : nativeView.getPaddingRight() / density;
        var bottomPadding = v.style.paddingBottom ? v.style.paddingBottom : nativeView.getPaddingBottom() / density;
        nativeView.setPadding(Math.round((background.borderLeftWidth + leftPadding) * density), Math.round((background.borderTopWidth + topPadding) * density), Math.round((background.borderRightWidth + rightPadding) * density), Math.round((background.borderBottomWidth + bottomPadding) * density));
    }
